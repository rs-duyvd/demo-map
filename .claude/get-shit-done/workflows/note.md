...
- **Global scope**: `/home/duyvd/Projects/hanatour/demo-map/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/duyvd/Projects/hanatour/demo-map/.claude/notes/`)
...
2. Glob `/home/duyvd/Projects/hanatour/demo-map/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/duyvd/Projects/hanatour/demo-map/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/duyvd/Projects/hanatour/demo-map/.claude/notes/` — works in any directory
