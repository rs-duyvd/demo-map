...
- Usage: Reference from command with `@/home/duyvd/Projects/hanatour/demo-map/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/duyvd/Projects/hanatour/demo-map/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/duyvd/Projects/hanatour/demo-map/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
